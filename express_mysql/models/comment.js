...
module.exports = class Comment extends Sequelize.Model {
    ...
    static associate(db) {
        db.Comment.belongsTo(db.Post, {foreignKey: 'fk_post_id', targetKey: 'id'});
        // 같은 모델끼리 N:M 관계를 갖는다.
        // 사용자 한 명이 팔로워를 여러 명 가질 수도 있고, 한 사람이 여러 명을 팔로우할 수 있음.
        db.Comment.belongsTo(db.User, {foreignKey: 'fk_user_id_comment', targetKey: 'id'});
